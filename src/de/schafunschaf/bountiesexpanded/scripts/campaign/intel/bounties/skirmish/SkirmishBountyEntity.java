...
public class SkirmishBountyEntity implements BountyEntity {
    ...
    public SkirmishBountyEntity(FactionAPI offeringFaction, FactionAPI targetedFaction, MarketAPI targetMarket) {
        this.offeringFaction = offeringFaction;
        this.targetedFaction = targetedFaction;
        this.targetMarket = targetMarket;
        this.baseShipBounty = Settings.skirmishBaseShipBounty;
        ...
        if (baseBountyIntel.isEnding() && isUpdate) {
            ...
            if (isUpdate && latestResult != null) {
                ...
                if (!baseBountyIntel.isEnding()) {
                    info.addPara("Faction: " + offeringFaction.getDisplayName(), initPad, tc,
    ...
    public void createSmallDescription(BaseBountyIntel baseBountyIntel, TooltipMakerAPI info, float width, float height) {
        ...
        Color[] factionAndHighlightColors = {offeringFaction.getColor(), targetedFaction.getColor(), highlightColor};
        ...
        info.addPara("Due to ongoing interfaction hostilities, %s is seeking privateers to raid rival %s fleets %s.",
                opad,
